while (True):
    ...
    # creating table for storing username and password of the user
    mycursor.execute(
    ...
    while (True):
        ...
        # USER LOGIN
            ...
            for i in row:
                        ...
                        if a == 1:
                            ...
                            # to delete data
                                ...
                                if c == 1:
                                    ...
                                    print(row)
                                    p = input(
                                        "Do you really want to delete this data? (y/n):")
                                    if p == "y":
                                        mycursor.execute(
                ...
                # USERNAME AND PASSWORD NOT PRESENT IN THE DATABASE
                else:
                    print("""         
                         * * * * * * INVALID DATA * * * * * *
                    """)
